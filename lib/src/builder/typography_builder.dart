                ...
                config.typography.map(
                  (t) => Field(
                    (b) => b
                      ...
                      ..docs.addAll([
                        '/// Text Style Definition ${t.validName}',
                      ])
                      ..assignment = textStyleRef.newInstance([], {
                        'fontFamily': t.family != null
                            ? literalString(t.family!)
                            : literalNull,
                        'fontWeight': t.weight != null
                            ? weightRef.property('w${t.weight}')
                            : literalNull,
                        'fontSize': t.size != null
                            ? literalNum(t.size!)
                            : literalNull,
                ...
                config.typography.map(
                  (t) => EnumValue(
                    (b) => b
                      ...
                      ..arguments.add(
                        refer('AppTypographies').property(t.validName),
                      ),
                  ),
                ),
              ),
