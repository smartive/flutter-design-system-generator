              ...
              ..methods.add(
                Method(
                  (b) => b
                    ...
                    ..lambda = true
                    ..returns = insetsRef
                    ..body = insetsRef.newInstanceNamed('all', [
                      refer('value'),
                    ]).code,
                ),
              )
              ..methods.add(
                Method(
                  (b) => b
                    ...
                    ..lambda = true
                    ..returns = insetsRef
                    ..body = insetsRef.newInstanceNamed('symmetric', [], {
                      'horizontal': refer('value'),
                    }).code,
                ),
              )
              ..methods.add(
                ...
                Method(
                  (b) => b
                    ...
                    ..body = insetsRef.newInstanceNamed('only', [], {
                      'left': refer(
                        'left',
                      ).conditional(refer('value'), literalNum(0)),
                      'right': refer(
                        'right',
                      ).conditional(refer('value'), literalNum(0)),
                      'top': refer(
                ...
                config.spatials.map(
                  (s) => EnumValue(
                    (b) => b
                      ...
                      ..docs.addAll(['/// ${s.validName} (${s.space}px)'])
                      ..arguments.add(
                        refer('AppSpatials').property(s.validName),
                      ),
                  ),
                ),
              ),
