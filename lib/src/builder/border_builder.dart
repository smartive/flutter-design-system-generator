...
final class BorderBuilder extends DesignSystemBuilder {
  ...
  Library buildLibrary(DesignSystemConfig config) {
    ...
    final borderWidthRef = refer(
      'AppBorderWidth',
      './${config.name}.border_widths.dart',
    );
    final borderWidthRefNullable = refer(
      'AppBorderWidth?',
      './${config.name}.border_widths.dart',
    );
              ...
              ..methods.addAll([
                ...
                Method(
                  (b) => b
                    ...
                    ..returns = borderRef
                    ..lambda = true
                    ..body = borderRef.property('fromBorderSide').call([
                      borderSideRef.property('none'),
                    ]).code,
                ),
              ]),
